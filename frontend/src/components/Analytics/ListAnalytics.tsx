...
const ListAnalytics = ({ analytics, loading, onDelete, currentPage, numPages, onPageChange }: Props) => {
                    ...
                    <CardBox hasTable isList className={'rounded shadow-none'}>
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>StudentEngagement</p>
                                <p className={'line-clamp-2'}>{ item.student_engagement }</p>
                            </div>
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>InstructorPerformance</p>
                                <p className={'line-clamp-2'}>{ item.instructor_performance }</p>
                            </div>
