...
const EnrollmentsTablesPage = () => {
  ...
  const [filters] = useState([
          ...
          {label: 'PaymentStatus', title: 'payment_status', type: 'enum', options: ['Paid','Pending','Overdue']},
  ]);
  const addFilter = () => {
        const newItem = {
            id: uniqueId(),
    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox   className='mb-6' cardBoxClassName='flex flex-wrap'>
          <BaseButton className={'mr-3'} href={'/enrollments/enrollments-new'} color='info' label='New Item' />
          <BaseButton
              className={'mr-3'}
              color='info'
              label='Filter'
