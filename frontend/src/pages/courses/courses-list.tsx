...
const CoursesTablesPage = () => {
  ...
  const [filters] = useState([{label: 'CourseTitle', title: 'title'},{label: 'Description', title: 'description'},
    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox   className='mb-6' cardBoxClassName='flex flex-wrap'>
          <BaseButton className={'mr-3'} href={'/courses/courses-new'} color='info' label='New Item' />
          <BaseButton
              className={'mr-3'}
              color='info'
              label='Filter'
