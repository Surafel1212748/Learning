                ...
                <>
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {courses.analytics_course && Array.isArray(courses.analytics_course) &&
                              courses.analytics_course.map((item: any) => (
                                <tr key={item.id} onClick={() => router.push(`/analytics/analytics-view/?id=${item.id}`)}>
                        ...
                        {!courses?.analytics_course?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
