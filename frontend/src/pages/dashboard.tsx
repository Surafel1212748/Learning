...
const Dashboard = () => {
    ...
    async function loadData() {
        const entities = ['users','analytics','courses','discussion_boards','enrollments','instructors','students',];
        const fns = [setUsers,setAnalytics,setCourses,setDiscussion_boards,setEnrollments,setInstructors,setStudents,];
                    ...
                    <div className="flex justify-between align-center">
                        ...
                        <div>
                            <BaseIcon
                                ...
                                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                // @ts-ignore
                                path={'mdiAccountTie' in icon ? icon['mdiAccountTie' as keyof typeof icon] : icon.mdiTable || icon.mdiTable}
                            />
                        </div>
                    </div>
                </div>
