...
const InstructorsView = () => {
    ...
    return (
      <>
          ...
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={removeLastCharacter('View instructors')} main>
                <BaseButton
                  color='info'
                  label='Edit'
            ...
            <CardBox>
                ...
                <div className={'mb-4'}>
                    ...
                    <p>{instructors?.first_name}</p>
                </div>

                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>LastName</p>
                    <p>{instructors?.last_name}</p>
                </div>

                <FormField label='Multi Text' hasTextareaHeight>
                  <textarea className={'w-full'} disabled value={instructors?.qualifications} />
                </FormField>
